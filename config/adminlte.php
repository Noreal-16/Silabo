...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Datos de Identificacón de Asignatura',
            'url'  => '/informacion',
        ...
        [
            'text'    => 'Programación del proceso de aprendizaje de la asignatura',
            'icon'    => 'far fa-calendar-check',
            'submenu' => [
                [
                    'text' => 'Resultados de aprendizaje-Contenidos',
                    'icon'    => 'fas fa-poll',
                    'url'  => '/resultados',
                ],
                [
